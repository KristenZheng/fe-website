<template>
  <div class="contact">
    ...
    <div class="main">
      <h3 class="title">The benefits of Electra</h3>
      <div class="benefits">
        <dl>
          <dt>
          ...
          <dd>
            Increase revenue -
            <br />the longer your customer's phone is powered on the more money you earn
          </dd>
        </dl>
        <dl>
          <dt>
          ...
          <dd>
            ...
            <br />Simple design, High quality battery
            Friendly user App
          </dd>
        </dl>
